...
ManteInfoRou.get('/mantes/numero/:economico/:id', ManteInfoControllers.economico); // Pide el número economico -- /informe/mantes/numero/:economico/:id
ManteInfoRou.get('/mantes/fecha', ManteInfoControllers.mantenimientoSeleccionado); // Manda el mantenimiento seleccionado -- /informe/mantes/fecha
