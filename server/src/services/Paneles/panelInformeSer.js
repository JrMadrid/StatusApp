...
import { getInformes, SucursalExiste, postInforme, deleteInforme, comprobarID, informeArchivo } from "../../models/Paneles/panelInformeMod.js";
...
export const publicarInforme = async (descripcion, nombre, documento, frealizada, economico, informe) => {
