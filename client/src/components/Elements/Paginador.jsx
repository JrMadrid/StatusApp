        ...
        <>
            <div className='cajapadre'>
                ...
                {user && (user.id === 3 || user.id === 4) && props.tipo === 'sucursal' && (
                    <>
                        <DataSucursales user={user} data={itemsActuales} eleccion={props.eleccion} seleccion={props.seleccion} cantidad={props.cantidad} />
                    </>
                )}
                ...
                {user && (user.id === 3 || user.id === 4) && props.tipo === 'dispositivo' && (
                    <>
                        <DataDispositivos user={user} data={itemsActuales} listaDispositivos={props.listaDispositivos} eleccion={props.eleccion} cantidad={props.cantidad} />
                    </>
                )}
                ...
                {user && (user.id === 3 || user.id === 4) && props.tipo === 'mantenimiento' && (
                    <>
                        <DataMantenimientos user={user} data={itemsActuales} eleccion={props.eleccion} cantidad={props.cantidad} />
                    </>
                )}
                ...
                {user && (user.id === 1 || user.id === 2 || user.id === 3 || user.id === 4) && props.tipo === 'manuales' && (
                    <>
                        <TablaManuales data={itemsActuales} eleccion={props.eleccion} ver={props.ver} cantidad={props.cantidad} />
                    </>
                )}
                ...
                {user && (user.id === 1 || user.id === 2 || user.id === 3 || user.id === 4) && props.tipo === 'informes' && (
                    <>
                        <TablaInformes user={user} data={itemsActuales} eleccion={props.eleccion} ver={props.ver} cantidad={props.cantidad} />
                    </>
                )}
                ...
                {user && user.id === 1 && props.tipo === 'usuarios' && (
                    <>
                        <TablaUsuarios data={itemsActuales} eleccion={props.eleccion} cantidad={props.cantidad} />
                    </>
                )}
                ...
                {user && (user.id === 1 || user.id === 2) && props.tipo === 'sucursales' && (
                    <>
                        <TablaSucursales data={itemsActuales} eleccion={props.eleccion} seleccion={props.seleccion} cantidad={props.cantidad} />
                    </>
                )}
                ...
                {user && (user.id === 1 || user.id === 2) && props.tipo === 'dispositivos' && (
                    <>
                        <TablaDispositivos data={itemsActuales} eleccion={props.eleccion} listaDispositivos={props.listaDispositivos} cantidad={props.cantidad} />
                    </>
                )}
                ...
                {user && (user.id === 1 || user.id === 2) && props.tipo === 'mantenimientos' && (
                    <>
                        <TablaMantenimientos data={itemsActuales} eleccion={props.eleccion} cantidad={props.cantidad} />
                    </>
                )}
