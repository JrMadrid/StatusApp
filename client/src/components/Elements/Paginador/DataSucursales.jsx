            ...
            <table className='tablaData'>
                ...
                <tbody>
                    {data
                        ...
                        .map((item, index) => (
                            <tr key={item.id || item.economico || index}>
                                <td className='tdData'>
                                    <a href='/status' onClick={() => eleccion(item.economico)} className='link select'>
                                        <button className='ir'></button>
                                    </a>
                                </td>
                                <td className='tdData'>
                                    <a href='/mantes' onClick={() => seleccion(item.economico, 0)} className='link select'>
                                        <button className='ir'></button>
                                    </a>
                                </td>
